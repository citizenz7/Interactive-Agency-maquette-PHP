  ...
  <div class="container">
    <div class="row">
      ...
      <div id="whatwedo" class="col-sm-12 col-md-6 m-0 p-0 w-100 h-75">
    ...
    <div class="row">
      ...
      <div id="whatwedo" class="col-sm-12 pt-1 pb-5 w-100 h-75 text-center">
        <a href="#" class="myButton">Ask for price</a>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col m-0 p-0">
        <img class="img-fluid" src="img/portfolio/Layer13.jpeg" alt="portfolio1">
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div id="aboutus" class="col-sm-12">
        ...
        <div class="row text-center photos">
          <div class="col">
            <img class="img-fluid rounded-circle" src="img/About/Layer16.jpeg" alt="John Doe"><br>
          ...
          <div class="col">
            <img class="img-fluid rounded-circle" src="img/About/Layer17.jpeg" alt="John Doe"><br>
            <span class="text-white">John Doe</span>
            <p class="text-small text-muted">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            </p>
          ...
          <div class="col">
            <img class="img-fluid rounded-circle" src="img/About/Layer18.jpeg" alt="John Doe"><br>
            <span class="text-white">John Doe</span>
            <p class="text-small text-muted">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            </p>
          ...
          <div class="col">
            <img class="img-fluid rounded-circle" src="img/About/Layer19.jpeg" alt="John Doe"><br>
            <span class="text-white">John Doe</span>
            <p class="text-small text-muted">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
            </p>
